...
static PyObject *
s_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    format = fastargs[0];
    return_value = s_new_impl(type, format);
...
/*[clinic end generated code: output=73deacdfe09bb1a7 input=a9049054013a1b77]*/
